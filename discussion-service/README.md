...
Каждый комментарий в чтениях несёт `likeCount`, `dislikeCount` и `emojiCounts` (только ненулевые ключи). Вошедшему добавляются `viewerVote` и `viewerEmoji`: его собственный выбор; оба отсутствуют, если он ничего не ставил или не вошёл. Чужой выбор не отдаётся никому и нигде. У заглушек счётчики нулевые: реакции снимаются вместе с комментарием, а то, что он успел собрать, уходит в `author_reaction_total`.

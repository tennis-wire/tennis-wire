...
export const PALETTES: Record<PaletteKey, Palette> = {
    courtGreen: {
        ...
        darkColors: {
            ...
            liveBg: '#2A1515',
            tag: '#1A2E20',
            cardShadow: '0 1px 3px rgba(0,0,0,0.3), 0 6px 16px rgba(0,0,0,0.2)',
        },
    },
    deepNavy: {
        name: 'Deep Navy',
        ...
        colors: {
            ...
            liveBg: '#FEF2F2',
            tag: '#EEF0F8',
            cardShadow: '0 1px 3px rgba(30,58,95,0.06), 0 6px 16px rgba(30,58,95,0.04)',
        },
        darkColors: {
            bg: '#0C0F18',
            bgAlt: '#141825',
    ...
    clayCourt: {
        ...
        colors: {
            ...
            liveBg: '#FEF2F2',
            tag: '#F8F0E8',
            cardShadow: '0 1px 3px rgba(100,50,20,0.06), 0 6px 16px rgba(100,50,20,0.04)',
        },
        darkColors: {
            bg: '#161210',
            bgAlt: '#201A16',

// Mirrors public-web/lib/discussion/compose.ts, with one change: `newKey` has no default here.
...
export function keyFor(previous: Keyed | null, body: string, newKey: () => string): Keyed {

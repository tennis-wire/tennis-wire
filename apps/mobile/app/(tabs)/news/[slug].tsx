        ...
        <Screen>
            <ScrollView contentContainerStyle={{ padding: 16 }}>
                ...
                <Text variant="display">
                    Синнер выиграл Miami Open, обыграв Алькараса в трёх сетах
                </Text>
                ...
                <Text variant="body" style={{ marginBottom: 12 }}>
                    Янник Синнер одержал убедительную победу над Карлосом Алькарасом в финале Miami
                    Open со счётом 6-4, 3-6, 6-3, подтвердив свой статус первой ракетки мира.
                </Text>
                <Text variant="body" style={{ marginBottom: 12 }}>
                    Итальянец продемонстрировал великолепную игру на задней линии, выигрывая
                    ключевые розыгрыши в решающие моменты матча. Это его третий титул Masters 1000 в
                    сезоне.
                </Text>
                <Text variant="body">

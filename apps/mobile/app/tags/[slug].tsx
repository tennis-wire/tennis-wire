...
const ITEMS = [
    ...
    { id: '2', title: 'Сезон Синнера: как итальянец стал доминирующей силой', type: 'Материал', time: '1 день' },
    { id: '3', title: 'Синнер vs Алькарас: статистика личных встреч', type: 'Материал', time: '3 дня' },
]
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <Pressable style={{ paddingHorizontal: 16, paddingVertical: 14 }}>
                        <Text variant="caption" style={{ marginBottom: 4 }}>{item.type}</Text>

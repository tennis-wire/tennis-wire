...
`/me/settings/actions` — смена имени и удаление аккаунта. `/me/settings` редиректит на первый
раздел. Вкладка «Комментарии» нарисована неактивной: выборки по автору в `discussion-service`
нет, а `discussion-rules.md` §15.13 не решён.

Кабинет открывается и без входа — облик хранит браузер, не аккаунт, и незалогиненному видна
одна «Внешний вид». Разделы — маршруты, а не вкладки в состоянии страницы: на них ссылаются,
и в B4 сюда встаёт игнор-лист, ссылку на который требует §3.33.
